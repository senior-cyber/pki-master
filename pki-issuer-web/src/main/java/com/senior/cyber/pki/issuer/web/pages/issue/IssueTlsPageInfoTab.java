...
public class IssueTlsPageInfoTab extends ContentPanel {
    ...
    protected TextArea<String> ip_field;
    ...
    protected TextArea<String> dns_field;
...
//            this.issuer_provider.applyWhere("user", Sql.column(Certificate_.user) + " = " + session.getUserId());
    ...
    protected void onInitHtml(MarkupContainer body) {
        ...
        this.ip_field = new TextArea<>("ip_field", new PropertyModel<>(this, "ip_value"));
        this.ip_field.setLabel(Model.of("Subject Alternative Name"));
        this.ip_field.add(new ContainerFeedbackBehavior());
        this.ip_field.add(new CertificateSanValidator());
        ...
        this.dns_field = new TextArea<>("dns_field", new PropertyModel<>(this, "dns_value"));
        this.dns_field.setLabel(Model.of("Subject Alternative Name"));
        this.dns_field.add(new ContainerFeedbackBehavior());
        this.dns_field.add(new CertificateSanValidator());
    ...
    protected void saveButtonClick() {
        ...
        try {
            ...
            certificateService.certificateTlsGenerate(request, apiConfiguration.getCrl(), apiConfiguration.getAia());
