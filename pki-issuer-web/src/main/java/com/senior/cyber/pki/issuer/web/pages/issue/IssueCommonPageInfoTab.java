...
public class IssueCommonPageInfoTab extends ContentPanel {
    ...
    public IssueCommonPageInfoTab(String id, String name, TabbedPanel<Tab> containerPanel, Map<String, Object> data) {
