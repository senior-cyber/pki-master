...
@Bookmark("/my/certificate/revoke")
@AuthorizeInstantiation({Role.NAME_ROOT, Role.NAME_Page_MyCertificateRevoke})
public class CertificateRevokePage extends MasterPage {
    ...
    protected void onInitData() {
        super.onInitData();
        this.info_tab = new Tab("info", "Information", CertificateRevokePageInfoTab.class);
    }
