...
public class RootController {
    ...
    public ResponseEntity<JcaRootGenerateResponse> jcaRootGenerate(RequestEntity<JcaRootGenerateRequest> httpRequest) throws PEMException, CertificateException, NoSuchAlgorithmException, OperatorCreationException, CertIOException {
