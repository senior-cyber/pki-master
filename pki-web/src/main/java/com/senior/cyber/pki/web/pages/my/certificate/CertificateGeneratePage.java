...
@Bookmark("/my/certificate/generate")
@AuthorizeInstantiation({Role.NAME_ROOT, Role.NAME_Page_MyCertificateGenerate})
public class CertificateGeneratePage extends MasterPage {
    ...
    protected void onInitData() {
        super.onInitData();
        this.info_tab = new Tab("info", "Information", CertificateGeneratePageInfoTab.class);
    }
